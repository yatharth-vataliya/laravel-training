...
<div class="row my-4">
    <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="student_name" value="{{ (!empty($student) ? $student->student_name : (!empty(old('student_name')) ? old('student_name') : '')) }}" name="student_name" placeholder="Student Name">
    </div>
    <div class="col-md-3">
...
<div class="row py-4">
    ...
    <div class="col-md-3">
        ...
        <button class="btn btn-danger" id="delete_image"><i class="fas fa-trash"></i></button>
        @endif
