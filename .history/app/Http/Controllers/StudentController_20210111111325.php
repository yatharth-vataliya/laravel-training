...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = Validator::make(
            ...
            [
                ...
                'student_mobile' => 'required|string|max:13|min:10|unique:\App\Models\Student,student_mobile',
    ...
    public function update(Request $request)
    {
        ...
        if ($request->input('is_image_delete') == 'yes') {
            try {
                unlink(storage_path('app/profile_pictures/') . $student->getRawOriginal('student_profile_picture'));
